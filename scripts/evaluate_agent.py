...
SAMPLE_BFCL_DATA = [
    {
        ...
        "ground_truth": [
            {
                "function_name": {"name": ["get_weather"]},
    ...
    },
    {
        ...
        "ground_truth": [
            {
                "function_name": {"name": ["calculate_factorial"]},
                "arguments": {"number": 5},
            }
        ],
    },
    {
        ...
        "ground_truth": [
            {
                "function_name": {"name": ["calculate_triangle_area"]},
    ...
    },
    {
        ...
        "ground_truth": [
            {"function_name": {"name": ["sqrt"]}, "arguments": {"number": 16}}
        ],
    },
    {
        "id": "simple_4",
        ...
        "ground_truth": [
            {
                "function_name": {"name": ["fahrenheit_to_celsius"]},
                "arguments": {"fahrenheit": 100},
            }
        ],
    },
    {
        ...
        "ground_truth": [
            {
                "function_name": {"name": ["power"]},
                "arguments": {"base": 25, "exponent": 2},
            }
        ],
    },
    {
        ...
        "ground_truth": [
            {
                "function_name": {"name": ["get_current_time"]},
    ...
    },
    {
        ...
        "ground_truth": [
            {"function_name": {"name": ["add"]}, "arguments": {"a": 15, "b": 27}}
        ],
    },
    {
        "id": "simple_8",
        ...
        "ground_truth": [
            {"function_name": {"name": ["abs"]}, "arguments": {"number": -42}}
        ],
    },
    {
        "id": "simple_9",
        ...
        "ground_truth": [
            {
                "function_name": {"name": ["round"]},
                "arguments": {"number": 3.14159, "digits": 2},
            }
        ],
    },
]
...
SAMPLE_GAIA_DATA = [
    ...
    {
        "task_id": "gaia_13",
        "Question": "If a car travels 300 km in 3 hours, what is its average speed?",
        "Level": 2,
        "Final answer": "100",
    },
    {
...
Please call the appropriate function to answer the question."""
        ...
        if not is_correct and pred_name:
            is_correct = (
                gt_name.lower() in pred_name.lower()
    ...
    output_file = os.path.join(
        output_dir, f"bfcl_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    )
...
def run_gaia_evaluation(
    max_samples: int = 10, level: Optional[int] = None
) -> Dict[str, Any]:
    print(f"\n{'=' * 60}")
...
Question: {question}"""
        ...
        status = "✅" if is_correct else "❌"
        print(
            f"{status} {item['task_id']} (L{lvl}): 预测={predicted[:25]}, 期望={expected}"
        )
    ...
    os.makedirs(output_dir, exist_ok=True)
    output_file = os.path.join(
        output_dir, f"gaia_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    )
    with open(output_file, "w", encoding="utf-8") as f:
        json.dump(results, f, indent=2, ensure_ascii=False)
...
def main():
    ...
    parser.add_argument(
        "--benchmark", type=str, choices=["bfcl", "gaia", "all"], default="all"
    )
    ...
    if args.benchmark in ["gaia", "all"]:
        results["gaia"] = run_gaia_evaluation(
            max_samples=args.samples, level=args.level
        )
